...
install_soga() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/soga.tar.gz https://github.com/Anakindai/crack/raw/main/soga-cracked-linux64.tar.gz
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/Anakindai/crack/raw/main/soga-cracked-linux64.tar.gz"
    ...
    curl -o /usr/bin/soga -Ls https://github.com/Anakindai/crack/raw/main/soga.sh
